...
public class GongsigonggaoController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,GongsigonggaoEntity gongsigonggao, 
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,GongsigonggaoEntity gongsigonggao, 
		HttpServletRequest request){
        EntityWrapper<GongsigonggaoEntity> ew = new EntityWrapper<GongsigonggaoEntity>();
		PageUtils page = gongsigonggaoService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, gongsigonggao), params), params));
        return R.ok().put("data", page);
    ...
    public R info(@PathVariable("id") Long id){
		...
		gongsigonggao.setClicknum(gongsigonggao.getClicknum()+1);
		gongsigonggao.setClicktime(new Date());
		gongsigonggaoService.updateById(gongsigonggao);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,GongsigonggaoEntity gongsigonggao, HttpServletRequest request,String pre){
        EntityWrapper<GongsigonggaoEntity> ew = new EntityWrapper<GongsigonggaoEntity>();
