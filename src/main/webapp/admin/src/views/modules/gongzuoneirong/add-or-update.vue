<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="部门姓名" prop="bumenxingming">
          <el-input v-model="ruleForm.bumenxingming" 
              placeholder="部门姓名" clearable  :readonly="ro.bumenxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="部门姓名" prop="bumenxingming">
              <el-input v-model="ruleForm.bumenxingming" 
                placeholder="部门姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作标题" prop="gongzuobiaoti">
          <el-input v-model="ruleForm.gongzuobiaoti" 
              placeholder="工作标题" clearable  :readonly="ro.gongzuobiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工作标题" prop="gongzuobiaoti">
              <el-input v-model="ruleForm.gongzuobiaoti" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作安排" prop="gongzuoanpai">
          <el-input v-model="ruleForm.gongzuoanpai" 
              placeholder="工作安排" clearable  :readonly="ro.gongzuoanpai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工作安排" prop="gongzuoanpai">
              <el-input v-model="ruleForm.gongzuoanpai" 
                placeholder="工作安排" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="工作文件" prop="gongzuowenjian">
          <file-upload
          tip="点击上传工作文件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.gongzuowenjian" label="工作文件" prop="gongzuowenjian">
            <el-button type="text" size="small" @click="download(ruleForm.gongzuowenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bumenzhanghao = true;
          ...
          if(o=='bumenxingming'){
            this.ruleForm.bumenxingming = obj[o];
	    this.ro.bumenxingming = true;
            continue;
          }
          if(o=='gongzuobiaoti'){
            this.ruleForm.gongzuobiaoti = obj[o];
	    this.ro.gongzuobiaoti = true;
            continue;
          }
          if(o=='gongzuoshijian'){
      ...
      this.$http({
		...
		if(json.bumenxingming!=''&&json.bumenxingming){
              		this.ruleForm.bumenxingming = json.bumenxingming
		}
        } else {
	...
	this.ruleForm.gongzuoneirong = this.ruleForm.gongzuoneirong.replace(reg,'../../../ssm203t6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `gongzuoneirong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.gongzuoneirongCrossAddOrUpdateFlag = false;
                  this.parent.search();
