<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="婚姻状况" prop="hunyinzhuangkuang">
          <el-input v-model="ruleForm.hunyinzhuangkuang" 
              placeholder="婚姻状况" clearable  :readonly="ro.hunyinzhuangkuang"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="入公司时间" prop="rugongsishijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.rugongsishijian" 
                type="date"
                placeholder="入公司时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.rugongsishijian" label="入公司时间" prop="rugongsishijian">
              <el-input v-model="ruleForm.rugongsishijian" 
                placeholder="入公司时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="聘用形式" prop="pinyongxingshi">
          <el-input v-model="ruleForm.pinyongxingshi" 
              placeholder="聘用形式" clearable  :readonly="ro.pinyongxingshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="聘用形式" prop="pinyongxingshi">
              <el-input v-model="ruleForm.pinyongxingshi" 
                placeholder="聘用形式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="合同到期时间" prop="hetongdaoqishijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.hetongdaoqishijian" 
                type="date"
                placeholder="合同到期时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.hetongdaoqishijian" label="合同到期时间" prop="hetongdaoqishijian">
              <el-input v-model="ruleForm.hetongdaoqishijian" 
...
export default {
  data() {
	...
	bumen : false,
	zhiwu : false,
	rugongsishijian : false,
	zhuanzhengshijian : false,
	pinyongxingshi : false,
	hetongdaoqishijian : false,
	beizhu : false,
      },
      ruleForm: {
        zhanghao: '',
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhiwu = true;
          ...
          if(o=='rugongsishijian'){
            this.ruleForm.rugongsishijian = obj[o];
	    this.ro.rugongsishijian = true;
            continue;
          }
	    ...
	    this.ro.zhuanzhengshijian = true;
          ...
          if(o=='pinyongxingshi'){
            this.ruleForm.pinyongxingshi = obj[o];
	    this.ro.pinyongxingshi = true;
            continue;
          }
          if(o=='hetongdaoqishijian'){
            this.ruleForm.hetongdaoqishijian = obj[o];
	    this.ro.hetongdaoqishijian = true;
            continue;
          }
          if(o=='beizhu'){
