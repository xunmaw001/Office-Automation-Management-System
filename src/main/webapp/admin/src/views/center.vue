  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='bumen'"  label="部门账号" prop="bumenzhanghao">
          <el-input v-model="ruleForm.bumenzhanghao" readonly              placeholder="部门账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='bumen'"  label="部门姓名" prop="bumenxingming">
          <el-input v-model="ruleForm.bumenxingming"               placeholder="部门姓名" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.bumenzhanghao)&& 'bumen'==this.flag){
        this.$message.error('部门账号不能为空');
        return
      }
      if((!this.ruleForm.mima)&& 'bumen'==this.flag){
        this.$message.error('密码不能为空');
        return
      }
      if((!this.ruleForm.bumenxingming)&& 'bumen'==this.flag){
